...
export function App() {
  ...
  const { data: tagsResponse, isLoading } = useQuery<TagResponse>({
    ...
    // não pisca mais os dados, só vai exibir o conteúdo depois q ele carregar
    placeholderData: keepPreviousData,
    staleTime: 1000 * 60 // a cada 60seg qdo requisitar de novo aquela url vai limpar o cache
  })
